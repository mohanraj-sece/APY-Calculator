    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className={
              "lg:flex max-md:flex-col p-[30px] pr-4 xl:w-[75%]  max-lg:space-y-7  border-2 border-white rounded-[30px] shadow-md shadow-[#505C6227] bg-white bg-opacity-40 backdrop-blur-[30px]"            }
          >
            {/* Calculator */}
            <div className={"text-left text-lg lg:w-[50%]  "}>
              ...
              <div
                className={
                  "flex flex-warp justify-center  cursor-pointer "
                }
              >
                {/* Control boxes */}
                <div
                  className={
                    " border-[1px] border-dashed border-[#00D382] mt-[30px] p-[4px] rounded-[35px] w-[250px] h-[56px] flex justify-center items-center"
                  }
                >
                  <div
                    className={
          ...
          <div
            className={
              " max-h-[379px]  xl:w-[23%] px-[20px] py-[22px] max-xl:mt-[30px]  border-2 border-white rounded-[30px] shadow-md shadow-[#505C6227] bg-white bg-opacity-40 backdrop-blur-[30px] overflow-y-scroll "
            }
          >
