...
export default function Home() {
  ...
  },[Duration,Investment,pensionAmount,TotalAmount]);
    ...
    <>
      ...
      >
        <div>
          ...
          <div
            className={
              "text-zinc-900 text-4xl font-semibold text-center leading-tight [@media(max-width:300px)]:text-3xl"
            }
          >
          ...
          {/* Subheading */}
          <p className={"text-neutral-700 mt-3 text-center  [@media(max-width:300px)]:text-sm lg:text-base"}>
